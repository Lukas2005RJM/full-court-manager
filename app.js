...
function renderRotation(){
  ...
  if(benchList){benchList.style.cssText='display:grid!important;grid-template-columns:minmax(0,1fr)!important;grid-auto-rows:54px!important;align-content:start!important;justify-content:stretch!important;gap:0!important;overflow-y:auto!important;overflow-x:hidden!important;min-height:0!important;';[...benchList.children].forEach(row=>{row.style.cssText='display:grid!important;position:relative!important;inset:auto!important;width:auto!important;height:54px!important;min-height:54px!important;max-height:54px!important;margin:0!important;padding:5px!important;box-sizing:border-box!important;overflow:hidden!important;contain:strict!important;transform:none!important;';const image=row.querySelector('.bench-photo');if(image)image.style.cssText='display:block!important;width:36px!important;height:42px!important;min-width:36px!important;min-height:42px!important;max-width:36px!important;max-height:42px!important;object-fit:contain!important;position:static!important;margin:0!important;'})}
