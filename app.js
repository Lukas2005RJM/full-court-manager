...
function renderRotation(){
  ...
  if(benchList){benchList.className='bench-card-grid';benchList.removeAttribute('style');[...benchList.children].forEach(row=>{row.className='bench-card';row.removeAttribute('style');const image=row.querySelector('.bench-photo');if(image)image.removeAttribute('style')})}
